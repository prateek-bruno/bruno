...
describe('maxRedirects on-disk round trip', () => {
  describe.each(FORMATS)('%s format', (format) => {
    ...
    // parseInt stopped at the exponent, reading a value Bruno itself wrote as 1e+31 back as 1.
  ...
  it('agrees between bru and yml on a value above the former ceiling of 50', () => {
