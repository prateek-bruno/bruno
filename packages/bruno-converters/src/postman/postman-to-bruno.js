  ...
  item.forEach((i, index) => {
    ...
    if (isItemAFolder(i)) {
      ...
      try {
        ...
        // Handle maxRedirects setting. Postman's schema types this as a number but its exports
        // are not guaranteed to honour that, and an unusable value must not cost us the request.
